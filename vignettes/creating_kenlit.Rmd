...
knitr::include_graphics("~/vignettes/images/kenya_lens-2019-07-29 09-48-39.png")
```
...
knitr::include_graphics("~/vignettes/images/kenya_institutions-2019-07-29 10-01-51.png")
```
